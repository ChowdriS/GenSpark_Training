    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tweetsHashtags", x => x.Id);
                    table.ForeignKey(
                        name: "FK_tweetsHashtags_hashTags_HashTagId",
                        column: x => x.HashTagId,
                        principalTable: "hashTags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_tweetsHashtags_tweets_TweetId",
                        column: x => x.TweetId,
                        principalTable: "tweets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tweetsHashtags_HashTagId",
                table: "tweetsHashtags",
                column: "HashTagId");

            migrationBuilder.CreateIndex(
                name: "IX_tweetsHashtags_TweetId",
                table: "tweetsHashtags",
                column: "TweetId");

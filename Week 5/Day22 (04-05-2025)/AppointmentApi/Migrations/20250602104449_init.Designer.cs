...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppointmentApi.Models.DTO.DoctorsBySpecialityResponseDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AppointmentApi.Models.DoctorSpeciality", b =>
                {
            ...
            modelBuilder.Entity("AppointmentApi.Models.Patient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AppointmentApi.Models.Speciality", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AppointmentApi.Models.Appointment", b =>
                {
                    ...
                    b.HasOne("AppointmentApi.Models.Patient", "Patient")
            ...
            modelBuilder.Entity("AppointmentApi.Models.Doctor", b =>
                {
                    b.HasOne("AppointmentApi.Models.User", "User")
                        .WithOne("Doctor")
                        .HasForeignKey("AppointmentApi.Models.Doctor", "Email")
            ...
            modelBuilder.Entity("AppointmentApi.Models.DoctorSpeciality", b =>
                {
                    ...
                    b.HasOne("AppointmentApi.Models.Speciality", "Speciality")
                        .WithMany("DoctorSpecialities")
            ...
            modelBuilder.Entity("AppointmentApi.Models.Patient", b =>
                {
                    b.HasOne("AppointmentApi.Models.User", "User")
                        .WithOne("Patient")
                        .HasForeignKey("AppointmentApi.Models.Patient", "Email")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()

...
public interface IEventService
{
    ...
    public Task<PaginatedResultDTO<EventResponseDTO>> FilterEvents(EventCategory? category, Guid? cityId,EventType? type, string searchElement, DateTime? date, int pageNumber, int pageSize, bool isAdmin = false);

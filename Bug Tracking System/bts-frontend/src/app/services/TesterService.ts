...
import { Bug, BugResponse, BugSubmissionDTO, UpdateBugPatchDTO } from '../models/bug.model';
...
export class TesterService {
  ...
  getMyBugs(): Observable<BugResponse[]> {
    return this.http.get<BugResponse[]>(`${this.apiUrl}/my-bugs`, {
      headers: this.getAuthHeaders()
    });
  }
